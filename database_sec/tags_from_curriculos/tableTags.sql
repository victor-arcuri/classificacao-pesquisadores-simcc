...
-- AddForeignKey
ALTER TABLE "public"."researcher_tags_on_researchers" ADD CONSTRAINT "researcher_tags_on_researchers_researcher_id_fkey" FOREIGN KEY ("researcher_id") REFERENCES "public"."curriculos"("id_pesquisador") ON DELETE CASCADE ON UPDATE CASCADE;
